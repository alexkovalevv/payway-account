...
export default function Sidebar() {
    ...
    return (
        <div
            id="app-sidebar-1"
            className="block fidex surface-section h-screen hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-1 border-right-1 surface-border select-none"
            style={{width: "280px"}}
        >
